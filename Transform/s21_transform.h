#ifndef SRC_FACADE_S21_FACADE_H_
#define SRC_FACADE_S21_FACADE_H_
...
class Transform {  /// transdorm
 public:
  using unint = unsigned int;
  void transform(s21::Strategy &transform, double **vertex, double angle,
                 unint count);
};  // Facade

}  // namespace s21

#endif  // SRC_FACADE_S21_FACADE_H_
