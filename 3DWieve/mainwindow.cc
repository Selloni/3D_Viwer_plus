...
void MainWindow::on_rotateX_valueChanged(double arg1) {
  ui->sceneWidget->controller.transf.transform(
      rotate_x_, &ui->sceneWidget->qVertexes, arg1,
      ui->sceneWidget->controller.GetCountVertex());
  ui->sceneWidget->update();
}
...
void MainWindow::on_doubleSpinBox_6_valueChanged(double arg1) {
  ui->sceneWidget->controller.transf.transform(
      move_x_, &ui->sceneWidget->qVertexes, arg1,
      ui->sceneWidget->controller.GetCountVertex());
  ui->sceneWidget->update();
}
...
void MainWindow::on_doubleSpinBox_5_valueChanged(double arg1) {
  ui->sceneWidget->controller.transf.transform(
      move_y_, &ui->sceneWidget->qVertexes, arg1,
      ui->sceneWidget->controller.GetCountVertex());
  ui->sceneWidget->update();
}
...
void MainWindow::on_doubleSpinBox_4_valueChanged(double arg1) {
  ui->sceneWidget->controller.transf.transform(
      move_z_, &ui->sceneWidget->qVertexes, arg1,
      ui->sceneWidget->controller.GetCountVertex());
  ui->sceneWidget->update();
}
...
void MainWindow::on_but_scale_clicked() {
  ui->sceneWidget->controller.transf.transform(
      scale_, &ui->sceneWidget->qVertexes, tmp,
      ui->sceneWidget->controller.GetCountVertex());
  ui->sceneWidget->update();
}

void MainWindow::on_actioninfo_triggered() {
  QString a = QString::number(ui->sceneWidget->controller.GetCountVertex());
  QString b = QString::number(ui->sceneWidget->controller.GetCountFacets());
  QString info = "Name: " + qpath_file + '\n' + "Vertex: " + a + '\n' +
                 "Facets: " + b + '\n' + "Authors: Yakov and Iznulla" + '\n' +
                 '\n' + "❤ и ты симпатяшка ❤";
