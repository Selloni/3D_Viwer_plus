...
void s21::MoveX::transform(double **vertex, char xyz, double angle, unint count) {
    static double diff1 = 0;
    for (unint i = 0; i < count * 3; i += 3) (*vertex)[i] += angle - diff1;
    diff1 = angle;
}

void s21::MoveY::transform(double **vertex, char xyz, double angle, unint count) {
    static double diff2 = 0;
    for (unint i = 1; i < count * 3; i += 3) (*vertex)[i] += angle - diff2;
    diff2 = angle;
}

void s21::MoveZ::transform(double **vertex, char xyz, double angle, unint count) {
